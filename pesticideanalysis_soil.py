# -*- coding: utf-8 -*-
"""PesticideAnalysis_Soil.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QAP8x13lDqfrJg_QPJrhCit2FyoNZLGV

## Import TensorFlow and other libraries

# **Below code only to rename DONT Execute EveryTime**
"""
...
import glob
import cv2 as cv
path = glob.glob("/content/sample_data/test/*.jpeg")
import os
i = 0
for file in path:
...
!zip -r /content/sample_data/results.zip /content/sample_data/results
files.download('/content/sample_data/results.zip')

from google.colab import files

!zip -r /content/sample_data/val.zip /content/sample_data/val
files.download('/content/sample_data/val.zip')

from google.colab import files

!zip -r /content/sample_data/train.zip /content/sample_data/train
files.download('/content/sample_data/train.zip')
...
import glob
path = glob.glob("/content/sample_data/train/*.jpg")
inp, re = load('/content/sample_data/Soil_withoutPesticide_original.jpg')
inp = tf.image.resize(re,[256,256])
re = tf.image.resize(re,[256,256])
k = 1
for file in path:
  print(file)
  sample_image = tf.io.read_file(file)
  sample_image= tf.io.decode_jpeg(sample_image)
  sample_image = tf.image.resize(sample_image, [256,512])
  plt.figure()
  ...
  for i in range(4):
    ...
    plt.axis('off')
    plt.show()
  train_dataset = tf.data.Dataset.list_files('/content/sample_data/train/*.jpg')
  ...
  print(train_dataset)
  try:
    test_dataset = tf.data.Dataset.list_files('/content/sample_data/test/*.jpg')
  except tf.errors.InvalidArgumentError:
    test_dataset = tf.data.Dataset.list_files('/content/sample_data/val/*.jpg')
  ...
  with open("/content/sample_data/results/out%s" % k , "wb") as fp:
    for chunk in gen_output:
        fp.write(chunk)
  k=k+1
# Casting to int for matplotlib to display the images

  #sample_image1 = tf.io.read_file(str(PATH / 'train/1.jpg'))
